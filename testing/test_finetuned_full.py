...
print("=" * 80)
print("TESTING FINE-TUNED BERT - FULL TEST SET")
print("=" * 80)
...
print(f"Test: {len(test_data):,} pairs (FULL SET)")
...
# Load or compute validation scores for calibration
...
if os.path.exists(calibration_file) and os.path.exists(threshold_file):
    ...
    print("\n1. Computing validation scores for calibration...")
    val_scores = []
...
# Compute test scores
print("\n2. Computing test scores (FULL SET)...")
test_scores = []
...
print("\n3. Computing calibrated predictions...")
...
print("\n" + "=" * 80)
print("RESULTS: FINE-TUNED BERT + CALIBRATION (FULL TEST SET)")
print("=" * 80)
...
# Save results
print("\n4. Saving results...")
np.savez('finetuned_test_results_full.npz',
         scores=test_scores.flatten(),
         probs=test_probs,
         predictions=predictions,
         labels=test_labels,
         threshold=optimal_threshold)
print("  Saved: finetuned_test_results_full.npz")
